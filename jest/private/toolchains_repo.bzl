...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@aspect_rules_jest//jest:toolchain_type"]
    return [
        toolchain_info,
        toolchain_info.default,
        toolchain_info.jestinfo,
...
resolved_toolchain = rule(
    ...
    toolchains = ["@aspect_rules_jest//jest:toolchain_type"],
...
# By default all these toolchains are registered by the jest_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:jest_toolchain",
    toolchain_type = "@aspect_rules_jest//jest:toolchain_type",
)
""".format(
            platform = platform,
